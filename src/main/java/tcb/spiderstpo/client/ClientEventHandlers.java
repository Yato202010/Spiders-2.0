        ...
        if (entity instanceof IClimberEntity) {
            ...
            if (renderOrientation != null) {
                ...
                if (Minecraft.getInstance().getEntityRenderDispatcher().shouldRenderHitBoxes()) {
                    ...
                    builder.vertex(matrix4f, 0, 0, 0).color(0, 1, 1, 1).normal(1, 1, 1).endVertex();
                    builder.vertex(matrix4f, (float) orientation.normal.x * 2, (float) orientation.normal.y * 2, (float) orientation.normal.z * 2).color(1.0f, 0.0f, 1.0f, 1.0f).normal(1, 1, 1).endVertex();
                    ...
                    builder.vertex(matrix4f, 0, entity.getBbHeight() * 0.5f, 0).color(0, 1, 1, 1).normal(1, 1, 1).endVertex();
                    builder.vertex(matrix4f, (float) orientation.localX.x, entity.getBbHeight() * 0.5f + (float) orientation.localX.y, (float) orientation.localX.z).color(1.0f, 0.0f, 0.0f, 1.0f).normal(1, 1, 1).endVertex();
                    ...
                    builder.vertex(matrix4f, 0, entity.getBbHeight() * 0.5f, 0).color(0, 1, 1, 1).normal(1, 1, 1).endVertex();
                    builder.vertex(matrix4f, (float) orientation.localY.x, entity.getBbHeight() * 0.5f + (float) orientation.localY.y, (float) orientation.localY.z).color(0.0f, 1.0f, 0.0f, 1.0f).normal(1, 1, 1).endVertex();
                    ...
                    builder.vertex(matrix4f, 0, entity.getBbHeight() * 0.5f, 0).color(0, 1, 1, 1).normal(1, 1, 1).endVertex();
                    builder.vertex(matrix4f, (float) orientation.localZ.x, entity.getBbHeight() * 0.5f + (float) orientation.localZ.y, (float) orientation.localZ.z).color(0.0f, 0.0f, 1.0f, 1.0f).normal(1, 1, 1).endVertex();
